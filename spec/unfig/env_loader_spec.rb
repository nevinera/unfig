RSpec.describe Unfig::EnvLoader do
  ...
  let(:foo) { instance_double(Unfig::ParamConfig, name: "foo", env: "FOO", multi?: false, type: "string") }
  let(:bar) { instance_double(Unfig::ParamConfig, name: "bar", env: "BAR", multi?: false, type: "boolean") }
  let(:baz) { instance_double(Unfig::ParamConfig, name: "baz", env: "BAZ", multi?: true, type: "integer") }
  let(:bam) { instance_double(Unfig::ParamConfig, name: "bam", env: "BAM", multi?: false, type: "float") }
